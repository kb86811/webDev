...
//****************************************************************************/
// the Reset button 
// the reset button will reset the score for bothn  to 0.
...
var p1Score=0;
var p2Score=0;
//selecting the score for player 1. we have added a span with id to the numerical parts of the h1 tag so we can select and update score as the user cliks the buttons. 
...
// and we want to remove the green class that is set in case it was clicked after a winning score
...
//here we are selctingthe spand inside of the p tag
